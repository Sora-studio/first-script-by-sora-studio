...
-- Lệnh superchat
addCommand("superchat", function(args)
    -- Tạo UI để người chơi nhập thông tin và chọn màu sắc, cỡ chữ
    ...
    textBox.PlaceholderText = "Nhập văn bản..."
    ...
    sizeButton.Size = UDim2.new(0, 100, 0, 40)
    sizeButton.Position = UDim2.new(0, 10, 0, 110)
    sizeButton.Text = "Chọn cỡ"
    ...
    local selectedColor = Color3.fromRGB(255, 0, 0) -- Mặc định là màu đỏ
    local selectedSize = 30 -- Mặc định là cỡ chữ 30

    -- Khi nhấn nút "Chọn màu", mở một menu để chọn màu
    colorButton.MouseButton1Click:Connect(function()
        local colorPicker = Instance.new("Frame")
        colorPicker.Size = UDim2.new(0, 200, 0, 200)
        colorPicker.Position = UDim2.new(0.5, -100, 0.5, -100)
        colorPicker.BackgroundColor3 = Color3.fromRGB(200, 200, 200)
        colorPicker.Parent = screenGui

        local closeButton = Instance.new("TextButton")
        closeButton.Size = UDim2.new(0, 50, 0, 50)
        closeButton.Position = UDim2.new(0, 150, 0, 150)
        closeButton.Text = "X"
        ...
        greenButton.Parent = colorPicker
    ...
    -- Khi nhấn nút "Chọn cỡ", mở menu để chọn cỡ chữ
    sizeButton.MouseButton1Click:Connect(function()
        local sizePicker = Instance.new("Frame")
        sizePicker.Size = UDim2.new(0, 100, 0, 100)
        sizePicker.Position = UDim2.new(0.5, -50, 0.5, -50)
        sizePicker.BackgroundColor3 = Color3.fromRGB(200, 200, 200)
        sizePicker.Parent = screenGui

        local smallButton = Instance.new("TextButton")
        smallButton.Size = UDim2.new(0, 50, 0, 30)
        smallButton.Position = UDim2.new(0, 10, 0, 10)
        smallButton.Text = "Nhỏ"
        smallButton.Parent = sizePicker
        ...
        mediumButton.Size = UDim2.new(0, 50, 0, 30)
        mediumButton.Position = UDim2.new(0, 10, 0, 50)
        mediumButton.Text = "Vừa"
        mediumButton.Parent = sizePicker
        ...
        largeButton.Size = UDim2.new(0, 50, 0, 30)
        largeButton.Position = UDim2.new(0, 10, 0, 90)
        largeButton.Text = "Lớn"
        largeButton.Parent = sizePicker
    ...
    -- Khi nhấn nút "Gửi", hiển thị superchat
    sendButton.MouseButton1Click:Connect(function()
        local message = textBox.Text
        if message ~= "" then
            -- Tạo phần tử hiển thị superchat cho toàn bộ người chơi
            local superChat = Instance.new("TextLabel")
            superChat.Text = message
            superChat.Font = Enum.Font.SourceSans
            superChat.TextSize = selectedSize
            superChat.TextColor3 = selectedColor
            superChat.BackgroundTransparency = 1
            superChat.Size = UDim2.new(0, 500, 0, 50)
            superChat.Position = UDim2.new(0.5, -250, 0, 10)
            superChat.Parent = game:GetService("Players").LocalPlayer.PlayerGui
...
addCommand("kick", function(args)
    local playerName = args[1]  -- Tên người chơi cần kick
    if playerName then
        -- Tìm người chơi trong game
        local player = game.Players:FindFirstChild(playerName)
        if player then
            -- Kick người chơi khỏi server
            player:Kick("Bạn đã bị kick khỏi server.")
        end
    end
end)
